-- Copyright (C) 2021-2022  aopkcn  <herboy2008@gmail.com> https://github.com/aopkcn/luci-app-ddns-go

local m, s ,o

m = Map("ddns-go")
m.title = translate("DDNS-GO")
m.description = translate("DDNS-GO automatically obtains your public IPv4 or IPv6 address and resolves it to the corresponding domain name service.")..translate("</br>For specific usage, see:")..translate("<a href=\'https://github.com/aopkcn/luci-app-ddns-go.git' target=\'_blank\'>GitHub @aopkcn/luci-app-ddns-go </a>")
